...
export const VARIETY_PACKS = [
  {
    ...
    flavors: ["1", "2", "3", "4"],
    flavorLabels: ["Classic Tea", "Peach Tea", "Raspberry Tea", "Lemonade & Tea"],
    description: "From Classic to Half & Half, experience the full SoulBreeze lineup in one pack.",
    totalCans: 8,
    rating: 5,
  },
];
...
export const PRODUCTS = [
  {
    ...
    ingredients:
      "Sparkling Water, Blue Agave Tequila (5%), Brewed Sweet Tea, Natural Lime Flavor, Citric Acid.",
    sizes: SIZES,
    packs: PACKS,
  },
  {
